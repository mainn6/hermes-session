...
S.append(f'<section class="slide center"><div class="kick">실습</div><h1>설치와 실습 자료는 디스코드에</h1>{qr("discord","discord.gg/QxeUpCUX",340)}<p class="note">입장하면 설치 순서 페이지, 가이드 PDF, 진행 덱, 질문 채널이 있습니다. 여기서부터 같이 설치합니다.</p></section>')
CSS='''
